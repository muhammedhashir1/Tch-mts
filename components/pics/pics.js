  ...
  return (
    <div className="h-700 bg-white flex justify-evenly items-center p-5">
      ...
      <div className="text-center flex flex-col items-center py-12 px-8">
        <Image src="/pics/image3.svg" alt="Pic 3" width={120} height={120} />
      ...
      {/* Pic 2 */}
      <div className="text-center flex flex-col items-center py-12 px-8">
        <Image src="/pics/image2.svg" alt="Pic 2" width={150} height={150} />
      ...
      {/* Pic 3 */}
      <div className="text-center flex flex-col items-center py-12 px-8">
        <Image src="/pics/image4.svg" alt="Pic 4" width={150} height={150} />
      ...
      {/* Pic 4 */}
      <div className="text-center flex flex-col items-center py-12 px-8">
        <Image src="/pics/image1.svg" alt="Pic 1" width={150} height={150} />
